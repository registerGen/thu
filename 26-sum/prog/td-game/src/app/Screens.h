...
public:
  explicit StartMenu(std::vector<LevelInfoView> infos, QWidget* parent = nullptr);
...
private:
  void buildLevelRows(std::vector<LevelInfoView> const& infos);
